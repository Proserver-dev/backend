const API_RESULTS = {
    ...
    ERR_USER_ALREADY_EXISTS: { description: "Użytkownik z takim mailem już istnieje", code: 'ERR_USER_ALREADY_EXISTS', status_code: 400 },
    ERR_ROLE_NAME_IS_RESERVED: { description: "Nie możesz dodać roli o tej nazwie", code: 'ERR_ROLE_NAME_IS_RESERVED', status_code: 403 },
    ERR_ROLE_ALREADY_EXISTS: { description: "Taka rola już istnieje", code: 'ERR_ROLE_ALREADY_EXISTS', status_code: 400 },
    ...
    ERR_ROLE_EDIT_ALREADY_EXISTS: { description: "Nie możesz zmienić nazwy roli na taką, taka już istnieje", code: 'ERR_ROLE_EDIT_ALREADY_EXISTS', status_code: 400 },
